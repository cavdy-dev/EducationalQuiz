...
public class java extends AppCompatActivity {
    ...
    public void button1(View view) {
        ...
        Intent button1 = new Intent(this, java2.class);
    ...
    public void button2(View view) {
        ...
        choosevalue = getanswer.getText().toString();
        Intent button2 = new Intent(this, java2.class);
    ...
    public void button3(View view) {
        ...
        choosevalue = getanswer.getText().toString();
        score = 0;
        Intent button3 = new Intent(this, java2.class);
    ...
    public void button4(View view) {
        ...
        choosevalue = getanswer.getText().toString();
        score = 0;
        Intent button4 = new Intent(this, java2.class);
    ...
    public void skip(View view) {
        ...
        score = 0;
        Intent skip = new Intent(this, java2.class);
