...
public class xml3 extends AppCompatActivity {
    int score;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xml3);
    ...
    public void submit(View view) {
        ...
        if(ansone == true) {
            ...
            Intent button2 = new Intent(this, xml4.class);
            ...
            choosevalue3 = getanswer.getText().toString();
            score = score + 0;
            Intent button3 = new Intent(this, xml4.class);
            ...
            choosevalue3 = getanswer.getText().toString();
            Intent button1 = new Intent(this, xml4.class);
    ...
    public void skip(View view) {
        ...
        score = score + 0;
        Intent skip = new Intent(this, xml4.class);
