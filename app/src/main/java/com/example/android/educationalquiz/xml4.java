...
public class xml4 extends AppCompatActivity {
    int score;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xml4);
    ...
    public void submit(View view) {
        ...
        if(ansone == true) {
            ...
            score = score + 1;
            Intent button2 = new Intent(this, xml5.class);
            ...
            choosevalue4 = getanswer.getText().toString();
            score = score + 0;
            Intent button3 = new Intent(this, xml5.class);
            ...
            choosevalue4 = getanswer.getText().toString();
            Intent button1 = new Intent(this, xml5.class);
    ...
    public void skip(View view) {
        ...
        score = score + 0;
        Intent skip = new Intent(this, xml5.class);
