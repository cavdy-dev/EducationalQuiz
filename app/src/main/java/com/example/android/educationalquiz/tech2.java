...
public class tech2 extends AppCompatActivity {
    ...
    public void button1(View view) {
        ...
        Intent button1 = new Intent(this, tech3.class);
    ...
    public void button2(View view) {
        ...
        choosevalue2 = getanswer.getText().toString();
        Intent button2 = new Intent(this, tech3.class);
    ...
    public void button3(View view) {
        ...
        choosevalue2 = getanswer.getText().toString();
        score = score + 0;
        Intent button3 = new Intent(this, tech3.class);
    ...
    public void button4(View view) {
        ...
        choosevalue2 = getanswer.getText().toString();
        score = score + 0;
        Intent button4 = new Intent(this, tech3.class);
    ...
    public void skip(View view) {
        ...
        score = score + 0;
        Intent skip = new Intent(this, tech3.class);
